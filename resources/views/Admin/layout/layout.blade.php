...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('admin/index') }}">饱否后台首页</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('admin/index') }}"><i class="fa fa-dashboard fa-fw"></i>首页</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/user/create') }}">用户添加</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa  fa-file-o  fa-fw"></i> 商家管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/seller/create') }}">商家添加</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/seller') }}">商家详情表</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/sjrz') }}">商家入驻表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/classify/create') }}">分类添加</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/classify') }}">分类列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa  fa-comment-o  fa-fw"></i> 评价管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/eval') }}">评价列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-share-alt fa-fw"></i> 友情链接<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/link/add') }}">友情链接添加</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/link') }}">友情链接列表</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="{{ url('admin/conf') }}"><i class="fa  fa-gear fa-fw"></i> 网站配置<span class="fa arrow"></span></a>
    ...
    <script src="{{ asset('/public/admin/bower_components/bootstrap/dist/js/fileupload.min.js') }}"></script>
