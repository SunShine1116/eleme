...
<html class="no-js" lang="zh">
 <head> 
  ...
  <script class="usemin" src="{{ asset('home/js/cdn_detect.66c19641.js') }}"></script> 
  <script>
  ...
  <script class="usemin" src="{{ asset('home/js/modernizr.custom.min.f49cdc05.js') }}"></script> 
  <script>
   ...
   <div class="container"> 
    ...
    <div class="mobile-wrap"> 
     ...
     <div id="popup_mobile" class="popup-mobile"> 
      ...
      <div class="panel"> 
       ...
       <a class="qrcode" href="mobile.html" target="_blank"><img src="{{ asset('shop/images/app-qrcode-72.85a69c07.png') }}" alt="扫一扫，手机订餐更方便" /></a> 
    ...
    <nav class="topbar-nav" role="navigation"> 
     <ul class="topbar-site-nav"> 
      <li><a class="tnav-link" href="member_index">我的饿单</a></li> 
      <li><a class="tnav-link" href="gift">礼品中心</a></li> 
      
      <li><a class="tnav-link" href="support">联系客服</a></li> 
     </ul> 
   ...
   <div class="container rst_header_con"> 
    <article class="rst-header-main rst-header-toggle rst_info_header" itemscope="" itemtype="http://schema.org/Restaurant"> 
     <header class="rst-header-info group"> 
      <a class="rst-logo" href="shop_detail" itemprop="url"> <img class="rst-logo-img" srcset="http://fuss10.elemecdn.com/c/64/241a5ff7023c8d49bc18495faf417jpg.jpg?w=48&amp;h=48 1x, http://fuss10.elemecdn.com/c/64/241a5ff7023c8d49bc18495faf417jpg.jpg?w=96&amp;h=96 2x" alt="绝味鸭脖" itemprop="logo" /> <i class="icon-rst-badge v v-person" title="该商家已通过个人身份认证"></i> </a> 
      <div class="rst-basic-info"> 
       <div class="rst-name-wrapper caret"> 
        <a class="rst-name text-overflow" href="shop_detail" data-toggle="bs-tooltip" title="绝味鸭脖" itemprop="name">绝味鸭脖</a> 
       </div> 
       <div class="rst-misc"> 
        <a id="rst_rating" class="rst-rating" href="shop_detail/rating"> <span class="rating-stars"> <i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star">★</i><i class="glyph-rating-star off">★</i></span> 3.8 </a> 
     ...
     <div class="rst-header-detail rst-header-dropdown"> 
      <section class="rst-header-rating group"> 
       <div class="rating-point header" itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating"> 
        ...
        <a class="comment" href="shop_detail/rating"><span itemprop="reviewCount">8</span>人评价</a> 
       </div> 
    ...
    <nav class="rst-header-nav"> 
     <a class="rst-header-nav-item" href="shop_detail">菜单</a> 
     <div class="inline-block relative"> 
      <span class="rst-header-nav-tip">看图点菜</span> 
      <a class="rst-header-nav-item" href="shop_photos">美食墙</a> 
     </div> 
     <a class="rst-header-nav-item" href="shop_comments">评价</a> 
     <a class="rst-header-nav-item " href="shop_message">留言</a> 
    </nav> 
 ...
 @yield('content')
  ...
  <div id="mod_fixed" class="global-mod-fixed"> 
   ...
   <div class="btn-app-qrcode"> 
    ...
    <img class="img-qrcode" src="{{ asset('shop/images/app-qrcode.20cdda49.png') }}" alt="扫描二维码免费下载手机App" /> 
   </div> 
  ...
  <script class="usemin" src="{{ asset('shop/js/vendor.7aa05b99.js') }}"></script> 
  <script class="usemin" src="{{ asset('shop/js/global.8d3089f1.js') }}"></script> 
  <script>
      ...
      ga('send','pageview','restaurant_comment/allshop_detail');
  ...
  <script class="usemin" src="{{ asset('home/js/rstComment.85f43302.js') }}"></script>   
 </body>
</html>