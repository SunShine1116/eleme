...
<html class="no-js" lang="zh">
 <head> 
  <meta charset="utf-8" /> 
  <title>密码重置-password_reset.html</title> 
 ...
 <body class="page-account"> 
  <header class="header"> 
   <h1 class="header-hd" title="ele.me | 叫外卖？上饿了么!"> <a class="logo" role="logo" href="http://ele.me"> 
     ...
     </svg> <img class="logo-img" src="images/logo.b38593f4.png" alt="ele.me| 叫外卖？上饿了么！" /> </a> </h1> 
  </header> 
  <div class="container clrfix"> 
   ...
   <div class="panel"> 
    ...
    <div class="panel-bd"> 
     <form id="reset_password_form" class="form" action="" method="" autocomplete="off"> 
      <div class="form-item"> 
       <input id="register_password" class="inputbox" name="password" type="password" minlength="6" maxlength="20" placeholder="新密码" required="" /> 
       <div class="g-error-tip hide"></div> 
      </div> 
      <div class="form-item"> 
       <input id="register_repeat_password" class="inputbox" name="repeat" type="password" minlength="6" maxlength="20" placeholder="确认密码" required="" /> 
       <div class="g-error-tip hide"></div> 
      </div> 
      <div class="form-item clrfix"> 
       ...
       <div class="g-error-tip hide"></div> 
       <img id="captcha_img" class="captcha-img" data-action="reset_password" src="//v5.ele.me/captcha?action=reset_password" alt="验证码" title="请填写验证码" /> 
      </div> 
      <input type="hidden" name="token" /> 
      <button class="g-btn g-btn-submit g-btn-l btn-individual" type="submit">确认</button> 
     </form> 
    </div> 
