 ...
 <body class="page-account"> 
  <header class="header"> 
   <h1 class="header-hd" title="ele.me | 叫外卖？上饿了么!"> <a class="logo" role="logo" href="http://ele.me"> 
     ...
     </svg> <img class="logo-img" src="{{ asset('home/images/logo.b38593f4.png') }}" alt="ele.me| 叫外卖？上饿了么！" /> </a> </h1> 
  </header> 
  <div class="container clrfix"> 
   ...
   <div class="panel"> 
    <div class="panel-hd clrfix" id="login-panel-hd"> 
     ...
     <a class="g-link link-mobile" href="#login_form_mobile">手机验证码登录</a> 
     <a class="g-link link-normal hide" href="#login_form">普通方式登录</a> 
    </div> 
    <div class="panel-bd"> 
     <form id="login_form" class="login-form block"> 
      <div class="form-item"> 
       <input class="inputbox" name="username" type="text" minlength="5" placeholder="用户名/电子邮箱/手机号" required="" /> 
      ...
      <div class="form-item clrfix"> 
       ...
       <div class="g-error-tip hide"></div> 
       <img id="captcha_img" class="captcha-img" data-action="login" src="//v5.ele.me/captcha?action=login" alt="验证码" title="请填写验证码" /> 
      </div> 
     ...
     <form id="login_form_mobile" class="login-form"> 
      <div class="form-item"> 
      ...
      <div class="form-helper"> 
       <label class="login-checkbox"> <input class="js_login_remember" type="checkbox" name="remember" checked="true" /> 下次自动登录 </label> 
       <a class="g-link" href="forget.html">忘记密码了？</a> 
      </div> 
      <button class="g-btn g-btn-l g-btn-submit" type="submit">登录</button> 
      <div class="form-helper"> 
       <div class="form-text"> 
        <p>收不到短信？使用 <a id="voice_btn">语音验证码<span class="voice-time hide">60秒</span></a> </p> 
    ...
    <div class="panel-ft"> 
     ...
     <a class="g-link js_link_register" href="register.html">免费注册</a> 
    </div> 
