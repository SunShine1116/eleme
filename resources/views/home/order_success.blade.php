...
<html class="no-js" lang="zh">
 <head> 
  ...
  <link class="usemin" rel="stylesheet" href="home/css/global.2730d877.css" /> 
  <link class="usemin" rel="stylesheet" href="home/css/order.58f4e423.css" /> 
  <script class="usemin" src="home/js/cdn_detect.66c19641.js"></script> 
  <script>
...
"> 
  <div class="container"> 
   ...
   <div id="cart_wrap" class="cart-container order-success"> 
    <article id="order_success" class="order-module" data-id="12266119358749105"> 
     ...
     <p class="omodule-actions"> <a class="ui-btn btn-small" href="http://ele.me/profile/order">追踪饿单</a> <a class="ui-btn btn-small" href="//r.ele.me/ayzhssnzzbql">返回餐厅</a> <a class="ui-btn btn-small btn-rp-test" data-toggle="bs-modal" data-target="#modal_rpTest" role="button">谁去拿外卖</a> </p> 
    </article> 
    <aside class="osuccess-aside"> 
     ...
     <img class="osuccess-qr" src="images/qrCode.797c160b.png" alt="扫一扫装饿了么手机应用" /> 
    </aside> 
  ...
  <script class="usemin" src="home/js/vendor.9fb19c23.js"></script> 
  <script class="usemin" src="home/js/global.8d3089f1.js"></script> 
  <script>
  ...
  <script class="usemin" src="js/orderSuccess.4d5dd330.js"></script>   
 </body>
</html>