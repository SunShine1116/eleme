  ...
  <div class="container clrfix"> 
   ...
   <div class="panel"> 
    ...
    <div class="panel-bd"> 
     ...
     <form id="register_form"  actuon="/register" method="post" autocomplete="off"> 
        {{ csrf_field() }}
        <div class="form-item"> 
        ...
        <div class="form-item clrfix"> 
            ...
            <div class="g-error-tip hide"></div> 
          <img id="captcha_img" class="captcha-img" data-action="register" src="" alt="验证码" title="请填写验证码" /> 
        </div> 
        <button class="g-btn g-btn-l g-btn-submit" type="submit">注册</button> 
     </form> 
    </div> 
