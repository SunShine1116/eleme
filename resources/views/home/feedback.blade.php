...
<html lang="zh">
 <head> 
  ...
  <title>反馈留言-feedback.html</title> 
...
<![endif]--> 
  <script type="text/javascript">
  var ma = "feedback/index";
  var logined = true;
  var eleme = eleme || {};
  var start_time = new Date().getTime();
  var current_username = 'hjl416148489';
  eleme.logined = eleme.logined || true;
  eleme.ma = eleme.ma || "feedback/index";
  eleme.place_id = eleme.place_id || "";
  eleme.sessionId = "e4b3db351cea625b0dcfa42450e70828";
 ...
 <body> 
  ...
  <div id="background" style="background-position:1px -9656.5277777778px;background-color:#C0DEED;" class=" night "> 
   <div id="sun"></div> 
   <div id="moon"></div> 
   <div id="clouds"> 
    <div id="cloudGroup1"> 
  ...
  <div class="full-content-wrapper"> 
   ...
   <div class="container"> 
    <div class="feedback-wrapper bordered-box"> 
     <h2>反馈留言</h2> 
     <div class="feedback-function"> 
     </div> 
     ...
     <div class="pagination"> 
      <ul> 
       ...
       <li class="active"><a href="/feedback?page=1">1</a></li> 
       <li><a href="/feedback?page=2">2</a></li> 
       <li><a href="/feedback?page=3">3</a></li> 
       <li><a href="/feedback?page=4">4</a></li> 
       <li><a href="/feedback?page=5">5</a></li> 
       <li><a href="/feedback?page=6">6</a></li> 
       <li><a href="/feedback?page=7">7</a></li> 
       <li><a href="/feedback?page=8">8</a></li> 
       <li><a href="/feedback?page=9">9</a></li> 
       <li><a href="/feedback?page=10">10</a></li> 
       <li class="next"><a href="/feedback?page=2">下一页 →</a></li> 
      </ul> 
     </div> 
     <div class="feedback-form"> 
      <form action="/feedback/create" method="post"> 
       <div class="control-group"> 
        <span class="required-mark">*</span> 留言类型： 
        <label class="radio inline"> <input type="radio" name="feedback[type]" value="1" /> 催单 </label> 
        <label class="radio inline"> <input type="radio" name="feedback[type]" value="2" /> 网站错误 </label> 
        <label class="radio inline"> <input type="radio" name="feedback[type]" value="3" /> 功能建议 </label> 
        <label class="radio inline"> <input type="radio" name="feedback[type]" value="4" /> 投诉 </label> 
       </div> 
       <input type="hidden" name="feedback[id]" id="feedback_id" />
       <input type="hidden" name="feedback[_csrf_token]" value="2dfdadb05f31340a732bef85652d1c22" id="feedback__csrf_token" /> 
       <textarea rows="5" cols="30" name="feedback[content]" id="feedback_content" class="xxlarge"></textarea> 
       <div class="captcha-wrapper clearfix"> 
        <label>请输入验证码：</label> 
        <input type="captcha" name="feedback[captcha]" class="captcha" id="feedback_captcha" />
        <a href="shop_detail.html" onclick="return false" title="Reload image"><img src="http://ele.me/captcha?1427455127" onclick="this.src=&quot;/captcha?r=&quot; + Math.random() + &quot;&amp;reload=1&quot;" border="0" class="captcha" /></a> 
       </div> 
       <div class="reToRst" style="display:none"> 
        <input type="checkbox" name="feedback[checkbox]" class="checkbox" id="feedback_checkbox" /> 
        <input type="text" name="feedback[restaurantId]" class="restaurantId" style="display:none" id="feedback_restaurantId" /> 
       </div> 
       <button type="submit" class="btn btn-yellow">发表留言</button> 
      </form> 
     </div> 
    </div>
    <!--end feedback--> 
  ...
  <script src="home/js/feedback_201503262210.js"></script> 
