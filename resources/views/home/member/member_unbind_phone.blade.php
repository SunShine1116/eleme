...
<html lang="zh">
 <head> 
  ...
  <title>个人中心 - 手机解绑-member_unbind_phone.html</title> 
...
<![endif]--> 
 ...
 <body> 
  ...
  <div id="background" style="background-position:1px -10697.777777778px;background-color:#C0DEED;" class=" night "> 
   <div id="sun"></div> 
   <div id="moon"></div> 
   <div id="clouds"> 
    <div id="cloudGroup1"> 
  ...
  <div class="full-content-wrapper"> 
   ...
   <div class="container"> 
    <nav class="breadcrumb" data-geohash="wtw3equp"> 
     ...
     <span class="breadcrumb-divider">/</span> 手机解绑 
    </nav> 
    <div class="wash-paper clearfix" id="profile"> 
     ...
     <div class="main-content"> 
      ...
      <div class="content-inner"> 
       <ol class="ui-profile-steps two-steps"> 
        <li class="active"><span>1. 验证原手机号</span></li> 
        <li class="last"><span>2. 手机解绑成功</span></li> 
       </ol> 
       <div class="alert rating-time-limit-tips;">
         点击获取验证码，我们会发送一条短信到您绑定的手机。请将短信中的验证码输入下方的输入框内完成验证。如果长时间未收到短信请等待60秒后再次点击获取验证码。 
       </div>
       <!--end rating-time-limit-tips--> 
       <form class="validate_terminal_code_form form-horizontal" id="send_former_mobile_code_form" name="send_former_mobile_code" action="javascript:void(0)"> 
        <fieldset> 
         <div class="control-group"> 
          <label class="control-label">已绑定手机号:</label> 
          <div class="controls"> 
           <p class="bound-phone">180****1538</p> 
          </div> 
         </div>
         <!--end control-group--> 
         <div class="form-actions"> 
          <button type="submit" class="btn btn-yellow" diff="" tabindex="4" name="send_terminal_code_btn" id="send_terminal_code_btn" terminal_type="0" is_new="0" sendto="/profile/SendFormerTerminalCode" data-loading="正在保存">获取验证码</button> 
         </div> 
        </fieldset> 
       </form> 
       <div class="divider"></div> 
       <form class="validate_terminal_code_form form-horizontal" id="validate_terminal_code_form" name="validate_terminal_code" action="javascript:void(0)"> 
        <fieldset> 
         <div class="control-group"> 
          <label class="control-label" for="sf_guard_user_validate_terminal_code">手机验证码：</label> 
          <div class="controls"> 
           <input type="text" name="sf_guard_user[validate_terminal_code]" id="sf_guard_user_validate_terminal_code" class="input_text" /> 
           <span class="help-inline hidden" id="validate_terminal_error"></span> 
           <div class="button ensure_message"> 
           </div> 
          </div> 
          <div class="form-actions"> 
           <button type="submit" class="btn btn-yellow" id="validate_terminal_code_btn" terminal_type="0" is_new="0" sendto="/profile/ValidateUnbindTerminalCode" returnto="/profile/security">确定</button> 
          </div> 
         </div> 
        </fieldset> 
       </form> 
  ...
  <script src="home/js/profile_201503262210.js"></script> 
