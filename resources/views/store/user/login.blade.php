        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                <div class="tpl-login-logo">
                    <img src="{{ asset('assets/img/logo_black_img.jpg') }}" style="padding-left:40px">
                ...
                <form class="am-form tpl-form-line-form" action="/store/dologin" method="post">
                    ...
                    <div class="am-form-group tpl-login-remember-me">
                        ...
                        <a href="{{ url('store/signUp') }}" style="float:right;font-size:12px">还没有账号？点击注册！</a>
                        <a href="" style="float:right;font-size:12px;margin-right:16px">忘记密码</a>
                    </div>
